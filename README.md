...
- **[Configuration](docs/configuration.md)**: every environment variable, with dedicated pages for [Logging](docs/logging.md), [Metrics](docs/metrics.md), [Error tracking](docs/sentry.md), and [S3 chunk staging](docs/s3-staging.md).
